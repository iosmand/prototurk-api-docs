...
Prototürk açık bir geliştirici platformu sunar; karşılığında bot’ların **şeffaf, hesap verebilir ve topluluğa saygılı** olmasını bekler. Bu kurallar <a href="https://dev.prototurk.com/developer-terms" target="_blank" rel="noreferrer noopener">Geliştirici Sözleşmesi</a>’nin bir özetidir.
