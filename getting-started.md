...
Prototürk’te giriş yap ve **[Ayarlar → Geliştirici](https://dev.prototurk.com/settings/developer)** sayfasına git. **Yeni uygulama** ile şunları doldur:
...
[ÖncekiGenel Bakış](index.md)[Sonraki Kimlik Doğrulama](authentication.md)