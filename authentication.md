...
*   **Üret:** Geliştirici portalında onaylı uygulamada _Token oluştur_. Ham token bir kez gösterilir.
...
[ÖncekiBaşlangıç](getting-started.md)[Sonraki Hız Limitleri ve Kotalar](rate-limits.md)